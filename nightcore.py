...
def prepare_audio(file_name, rate=44100, speedup=1.3):
    """ Read audio from a file, speed it up and return an AudioClip. """
...
def prepare_image(text, duration, fps=1):
    """ Load a random image and write text to it. """
...
def nightcorify(source_file, destination_file, text):
    """ Create a nightcore video, using the audio from the source_file, and
        write it to destination_file. Use the user text as a title. """
